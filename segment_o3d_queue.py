...
class ImageSegmentationNode:
    def __init__(self):
        ...
        self.mask_queue = deque(maxlen=self.frame_count)
    ...
    def integrate(self, intrinsic, depth_scale, depth_max, camera_info):
        ...
        for depth_image, color_image, mask in zip(self.depth_queue, self.color_queue, self.mask_queue):
            start = time.time()
            ...
            depth_o3d = o3d.t.geometry.Image(depth_image_masked).to(self.device)
